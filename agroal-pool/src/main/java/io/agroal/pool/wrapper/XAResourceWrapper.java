...
public class XAResourceWrapper extends AutoCloseableElement<XAResourceWrapper> implements XAResource {
    ...
    private static final class ClosedXAResource implements XAResource {
        ...
        @Override public void commit(Xid xid, boolean onePhase) throws XAException { throw new XAException( XAException.XAER_RMFAIL ); }
        @Override public void end(Xid xid, int flags) throws XAException { throw new XAException( XAException.XAER_RMFAIL ); }
        @Override public void forget(Xid xid) throws XAException { throw new XAException( XAException.XAER_RMFAIL ); }
        @Override public int getTransactionTimeout() throws XAException { throw new XAException( XAException.XAER_RMFAIL ); }
        @Override public boolean isSameRM(XAResource xares) throws XAException { throw new XAException( XAException.XAER_RMFAIL ); }
        @Override public int prepare(Xid xid) throws XAException { throw new XAException( XAException.XAER_RMFAIL ); }
        @Override public Xid[] recover(int flag) throws XAException { throw new XAException( XAException.XAER_RMFAIL ); }
        @Override public void rollback(Xid xid) throws XAException { throw new XAException( XAException.XAER_RMFAIL ); }
        @Override public boolean setTransactionTimeout(int seconds) throws XAException { throw new XAException( XAException.XAER_RMFAIL ); }
        @Override public void start(Xid xid, int flags) throws XAException { throw new XAException( XAException.XAER_RMFAIL ); }
